...
> **仅限授权使用。** Victrl 通过外置采集卡读取被控设备屏幕，并以标准蓝牙/USB 键鼠的方式驱动它。
> 请仅在你自己拥有、或已被明确书面授权操作的设备上使用。未经授权访问或控制他人计算机信息系统
> 可能构成犯罪。使用前请阅读[《合规与授权说明》](../Docs/合规与授权说明.md)。
...
Apache 2.0 —— 详见[《合规与授权说明》](../Docs/合规与授权说明.md)。仅限合法、已获授权的使用。
