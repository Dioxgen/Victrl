...
*Last reviewed: 2026-05 · applies to every Victrl implementation (the Python prototype and the ESP32-P4 build). The analysis is architectural and independent of implementation language.*
